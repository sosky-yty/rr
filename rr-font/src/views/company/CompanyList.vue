  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="24">
          <a-col :span="6">
            <a-form-item label="资源回收站名称">
              <a-input placeholder="请输入资源回收站名称" v-model="queryParam.name"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="6">
            <a-form-item label="管理区域">
              <a-input placeholder="请输入管理区域" v-model="queryParam.addr"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="8" >
    ...
    <!-- 表单区域 -->
    <company-modal ref="modalForm" @ok="modalFormOk"/>
